...
local FONT_         = MakeFont({used_DXUnicodeFontData = "font_cockpit_usa"},BASE_COLOR2,80,"test_font") --this is font object declaration. Mig-21 does not have fonts, therefore disabled.
local FONTROUGE_    = MakeFont({used_DXUnicodeFontData = "font_cockpit_usa"},BASE_COLOR,80,"test_font") --this is font object declaration. Mig-21 does not have fonts, therefore disabled.

local Heading_output         = CreateElement "ceStringPoly"
Heading_output.name            = create_guid_string()
Heading_output.material        = FONT_
Heading_output.init_pos        = {-100,50}
